  ...
  if (game.player.life === 0) {
    return (
      <section className="combat-panel combat-panel--defeat" aria-labelledby="combat-title">
        ...
        <h2 id="combat-title">Kuno holt Hilfe</h2>
        <p>Du bist erschöpft, aber nichts aus deinem Inventar oder deinen Entdeckungen geht verloren.</p>
    ...
    <section className="combat-panel" aria-labelledby="combat-title">
      <header className="combat-heading">
        <div>
          ...
          <h2 id="combat-title">{view.enemy.name}</h2>
        </div>
